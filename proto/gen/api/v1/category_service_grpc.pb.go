...
const (
	CategoryService_CreateCategory_FullMethodName       = "/memos.api.v1.CategoryService/CreateCategory"
	CategoryService_ListCategories_FullMethodName       = "/memos.api.v1.CategoryService/ListCategories"
	CategoryService_GetCategory_FullMethodName          = "/memos.api.v1.CategoryService/GetCategory"
	CategoryService_UpdateCategory_FullMethodName       = "/memos.api.v1.CategoryService/UpdateCategory"
	CategoryService_DeleteCategory_FullMethodName       = "/memos.api.v1.CategoryService/DeleteCategory"
	CategoryService_GetCategoryHierarchy_FullMethodName = "/memos.api.v1.CategoryService/GetCategoryHierarchy"
)
...
type CategoryServiceClient interface {
	...
	GetCategoryHierarchy(ctx context.Context, in *GetCategoryHierarchyRequest, opts ...grpc.CallOption) (*GetCategoryHierarchyResponse, error)
}
...
func (c *categoryServiceClient) GetCategoryHierarchy(ctx context.Context, in *GetCategoryHierarchyRequest, opts ...grpc.CallOption) (*GetCategoryHierarchyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCategoryHierarchyResponse)
...
type CategoryServiceServer interface {
	...
	// GetCategoryHierarchy gets the full category hierarchy for the authenticated user.
	GetCategoryHierarchy(context.Context, *GetCategoryHierarchyRequest) (*GetCategoryHierarchyResponse, error)
...
func (UnimplementedCategoryServiceServer) GetCategoryHierarchy(context.Context, *GetCategoryHierarchyRequest) (*GetCategoryHierarchyResponse, error) {
...
func _CategoryService_GetCategoryHierarchy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCategoryHierarchyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryHierarchy(ctx, req.(*GetCategoryHierarchyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "memos.api.v1.CategoryService",
